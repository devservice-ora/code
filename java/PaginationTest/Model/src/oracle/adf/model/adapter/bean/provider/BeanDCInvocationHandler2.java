...
public class BeanDCInvocationHandler2 implements InvocationHandler {
    ...
    public Object invokeMethod(String methodName, Class[] parameterTypes, Object[] args) {
        ...
        if (_dataProvider != null) {
            final Method method = findMethod(_dataProvider, methodName, parameterTypes);
            if (method != null) {
     ...
     * associated with.
     */
    public Object invoke(String methodName, Class[] parameterTypes, Object[] args) throws Exception {
