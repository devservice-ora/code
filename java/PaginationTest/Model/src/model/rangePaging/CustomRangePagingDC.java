...
public class CustomRangePagingDC extends AdapterDCService {
    ...
    public CustomRangePagingDC(String string, String string1, Object object, AbstractDefinition abstractDefinition) {
        super(string, string1, object, abstractDefinition);
    }
    
    @Override
    protected ViewDefImpl createViewDef(String strDefFullName, String vdName, oracle.jbo.StructureDef sd,
                                        AttributeDef[] fkAttrs, int vdKind) {
        ViewDefImpl vd = super.createViewDef(strDefFullName, vdName, sd, fkAttrs, vdKind);        
